...
class MainActivity : AppCompatActivity(), ChildrenAdapter.OnChildSelectedListener,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (intent.hasExtra(Constants.NOTIFICATION_STATUS)) {
            Timber.e(intent.getStringExtra(Constants.NOTIFICATION_STATUS))
            bottom_nav_view.findNavController().navigate(R.id.syllabusFragment)
        }
    }
